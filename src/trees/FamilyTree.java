...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		{
			parentNode = root.getNodeWithName(root.name);
			...
			if(parentNode==null)
			{
				throw new TreeException("something wrong w data file");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		TreeNode node1 = root.getNodeWithName(root.name);
		if (node1 == null)
		{
			throw new TreeException("something wrong w data file");
		}
		TreeNode node2 = root.getNodeWithName(root.name);		// node whose name is name2
		if (node2 == null)
		{
			throw new TreeException("something wrong w data file");
		}
